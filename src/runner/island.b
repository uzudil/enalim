addNpcDef({
    ...
    "convo": {
            ...
            if(player.gameState["ourdlen_done"] != null) {
                ...
                if(idx > -1) {
                    ...
                    if(player.gameState["chores_done"] = null || player.gameState["ghost_warning"] = null) {
                        return "The Necromancer seems lost in his thoughts today. \"The time is here, $Lydell. The Alturian $conjunction is near and we have still have much work to do!\" He impatiently motions for you to come closer.";
                    } else {
        ...
        "Lydell": "The Necromancer gives you that look you've seen many times before. \"Lydell is your name.\" (You feel immensely stupid.) \"You are my assistant here on my $island. \" - He continues, while glaring at you. You blush intensly, wishing you could be invisible.",
        ...
        "Enalim": "The Necromancer sighs heavily and stares at the sea. His eyes far away, as he's clearly contemplating a spell to end both your existence and the drain on his last bit of patience. \"Enalim,\" - he says slowly - \"is the world we live in. It is all you see around you. Now, can we get back to planning for the $conjunction? Or perhaps you have more inane questions to waste my day with?\"",
        ...
        "immediately": "The Necromancer seems both sad and disturbed: \"I can't... I can't perform the ritual. It is too late. Vesnu has $risen and you, Lydell are somehow the only one who can stop him.\". He suddenly seems small and frightened as he stares at you with what can only be describes as a look of admiration.",
        "risen": "He babbles on hopelessly: \"I don't understand it myself, but...\" - he waves the manuscript page - \"the portents are real: Vesnu has risen and all will soon be lost. Our only hope is that\" - here he reads the page to you, \"one born kinless, crimson of complexion, heir to Krynt will rise to the $challenge.\"",
        "challenge": "\"This clearly means you Lydell. I never told you about your past - because I don't know it myself. One day you were... just here... You must seek out Fearol on the $mainland, perhaps he will know what to do. And beware of the $agents of Vesnu along the way!\"",
        "mainland": "The Necromancer is back to his old impatient self again: \"Yes, yes, it's all been arranged. I have reconfigured the dimensional portal in the basement. It will now take you to the mainland. Hurry, there is no time to loose! When you arrive seek out Fearol!\"",
        "agents": "He explains: \"Vesnu is fast becoming be a powerful being of eldritch energy, but for now at least he has only partially entered Enalim. For now you must beware of evil men, monsters and other beings in his service. You are our last hope to stop Vesnu, so hurry!\"",
        "hurry": ">mainland",
    },
    "schedule": [
...
addNpcDef({
    ...
    "creature": "ghost",
    "convo": {
        "": "An apparition floats before you, clothed in the dusty robes of yore. \"I... oooo... arakw...\" - it croaks - \"I hath come to warn thee $Lydell, of events foretold.\" He apprently knows who you are.",
        "Lydell": "Before you can truly come to grips that your fame extends to the unlife, it continues: \"Tidings I bring thee, tidings I was bound to deliver. A $doom hangs on thee - its claws holding thee fast as coffin's nails.\" A fitting remark indeed.",
        "doom": "The ghost warbles on: \"Thou will travel far to eventually meet thy fate.\" - this can mean anything, you think, until it clarifies: \"An evil presence bleeds into this world from whence I hail. I have come to warn thee that it is thy doom to seek and $combat this evil, lest all will be no more.\"",
        "combat": "You're about to ignore these ramblings when it adds \"On thy travels seek thee the Azure Chalice of Krynt.\" - you swear it winks at you from under its hood - \"Now hurry Lydell back to thy $master. Aid him in his work, for he knows not what truly will come to pass.\"",
        "master": () => {
            player.gameState["ghost_warning"] := 1;
            return "After a dusty coughing fit, the ghost mumbles: \"Doth not know, I tell thee. I will not bother thee anymore - but shoulds't thou need to hear my $warning, just ask and I will speak anew.\". With that it hovers nearby, bobbing expectantly. You decie it looks harmless enough.";
        },
        "warning": ">Lydell",
    },
    "schedule": [
